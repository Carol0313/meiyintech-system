...
| 部署状态 | 生产阶段，使用 Gunicorn 127.0.0.1:8000 + PostgreSQL 13 + Nginx反向代理；服务器 ECS 4核8G；OSS 100G/年 已启用；systemd 自启动已配置；SSH 端口已改为 2222，root 登录已禁用，fail2ban 已启用 |
